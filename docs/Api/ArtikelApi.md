...
# **getArticle**
> \MittwaldApi\Model\Article getArticle($article_number, $fields)
...
# **getArticleUpgrades**
> \MittwaldApi\Model\ArticleUpgradeOption[] getArticleUpgrades($article_number)
...
> \MittwaldApi\Model\ArticleOption[] getCrossSellingOptions($article_number)
...
# **listArticles**
> \MittwaldApi\Model\Article[] listArticles($fields, $limit, $offset, $articles)
