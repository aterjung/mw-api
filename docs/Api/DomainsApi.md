...
# **createSubdomain**
> \MittwaldApi\Model\Subdomain[] createSubdomain($account_identifier, $domain_identifier, $subdomain_creation_body)
...
$subdomain_creation_body = array(new \MittwaldApi\Model\array()); // \MittwaldApi\Model\SubdomainCreationBody[] | Daten der neuen Subdomain

try {
    $result = $apiInstance->createSubdomain($account_identifier, $domain_identifier, $subdomain_creation_body);
    print_r($result);
} catch (Exception $e) {
 ...
 **subdomain_creation_body** | [**\MittwaldApi\Model\SubdomainCreationBody[]**](../Model/array.md)| Daten der neuen Subdomain |
...
# **domainProxyList**
> \MittwaldApi\Model\DomainProxy[] domainProxyList($account_identifier)
...
# **getDomainAuthCode**
> \MittwaldApi\Model\DomainAuthCode getDomainAuthCode($account_identifier, $domain_identifier)
...
# **getToplevelDomain**
> \MittwaldApi\Model\TopLevelDomain getToplevelDomain($top_level_domain_identifier, $fields)
...
> \MittwaldApi\Model\Domain[] listDomainsByAccount($account_identifier, $limit, $offset)
...
> \MittwaldApi\Model\Subdomain[] listSubdomainsByDomain($account_identifier, $domain_identifier)
...
# **listToplevelDomains**
> \MittwaldApi\Model\TopLevelDomain[] listToplevelDomains()
...
# **registerNewDomain**
> \MittwaldApi\Model\Domain[] registerNewDomain($account_identifier, $domain_registration)
...
$account_identifier = 'account_identifier_example'; // string | Name oder ID eines Accounts
$domain_registration = new \MittwaldApi\Model\DomainRegistration(); // \MittwaldApi\Model\DomainRegistration | Daten für eine Domain-Registrierung

try {
    $result = $apiInstance->registerNewDomain($account_identifier, $domain_registration);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **account_identifier** | **string**| Name oder ID eines Accounts |
 **domain_registration** | [**\MittwaldApi\Model\DomainRegistration**](../Model/DomainRegistration.md)| Daten für eine Domain-Registrierung |
