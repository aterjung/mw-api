...
class PromotionCodeApi
{
     ...
     */
    public function getPromotionCodeRequest($promotion_code)
    {
     ...
     *
     * @param  string $promotion_code PromotionCode (required)
     * @param  \MittwaldApi\Model\PromotioncodeValidierungsanfrage $data data (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $promotion_code PromotionCode (required)
     * @param  \MittwaldApi\Model\PromotioncodeValidierungsanfrage $data (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function verifyPromotionCodeRequest($promotion_code, $data)
    {
        // verify the required parameter 'promotion_code' is set
        if ($promotion_code === null || (is_array($promotion_code) && count($promotion_code) === 0)) {
            throw new \InvalidArgumentException(
