...
class DomainsApi
{
     ...
     */
    public function checkDomainAvailabilityRequest($domain_identifier)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteDomainRequest($account_identifier, $domain_identifier)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function domainProxyListRequest($account_identifier)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDomainAuthCodeRequest($account_identifier, $domain_identifier)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getToplevelDomainRequest($top_level_domain_identifier, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listDomainsByAccountRequest($account_identifier, $limit = 20, $offset = 0)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listToplevelDomainsRequest()
    {
     ...
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     * @param  \MittwaldApi\Model\DomainRegistration $body Daten für eine Domain-Registrierung (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function registerNewDomainRequest($account_identifier, $body)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
