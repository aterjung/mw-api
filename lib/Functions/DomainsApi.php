...
class DomainsApi
{
     ...
     * @param  \MittwaldApi\Model\SubdomainCreationBody[] $subdomain_creation_body Daten der neuen Subdomain (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MittwaldApi\Model\Subdomain[]
     */
    public function createSubdomain($account_identifier, $domain_identifier, $subdomain_creation_body)
    {
        list($response) = $this->createSubdomainWithHttpInfo($account_identifier, $domain_identifier, $subdomain_creation_body);
        return $response;
    }
     ...
     */
    public function createSubdomainWithHttpInfo($account_identifier, $domain_identifier, $subdomain_creation_body)
    {
        $request = $this->createSubdomainRequest($account_identifier, $domain_identifier, $subdomain_creation_body);
            ...
            switch($statusCode) {
                case 201:
                    if ('\MittwaldApi\Model\Subdomain[]' === '\SplFileObject') {
                        ...
                        if ('\MittwaldApi\Model\Subdomain[]' !== 'string') {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSubdomainAsync($account_identifier, $domain_identifier, $subdomain_creation_body)
    {
        return $this->createSubdomainAsyncWithHttpInfo($account_identifier, $domain_identifier, $subdomain_creation_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSubdomainAsyncWithHttpInfo($account_identifier, $domain_identifier, $subdomain_creation_body)
    {
        $returnType = '\MittwaldApi\Model\Subdomain[]';
        $request = $this->createSubdomainRequest($account_identifier, $domain_identifier, $subdomain_creation_body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createSubdomainRequest($account_identifier, $domain_identifier, $subdomain_creation_body)
    {
        ...
        // verify the required parameter 'subdomain_creation_body' is set
        if ($subdomain_creation_body === null || (is_array($subdomain_creation_body) && count($subdomain_creation_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subdomain_creation_body when calling createSubdomain'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($subdomain_creation_body)) {
            $_tempBody = $subdomain_creation_body;
        }
     ...
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MittwaldApi\Model\DomainProxy[]
     */
     ...
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MittwaldApi\Model\DomainProxy[], HTTP status code, HTTP response headers (array of strings)
     */
    public function domainProxyListWithHttpInfo($account_identifier)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MittwaldApi\Model\DomainProxy[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                        if ('\MittwaldApi\Model\DomainProxy[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MittwaldApi\Model\DomainProxy[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MittwaldApi\Model\DomainProxy[]';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MittwaldApi\Model\DomainAuthCode|\MittwaldApi\Model\Message
     */
     ...
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MittwaldApi\Model\DomainAuthCode|\MittwaldApi\Model\Message, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDomainAuthCodeWithHttpInfo($account_identifier, $domain_identifier)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MittwaldApi\Model\DomainAuthCode' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                        if ('\MittwaldApi\Model\DomainAuthCode' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MittwaldApi\Model\DomainAuthCode', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\MittwaldApi\Model\DomainAuthCode';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MittwaldApi\Model\DomainAuthCode',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MittwaldApi\Model\TopLevelDomain
     */
     ...
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MittwaldApi\Model\TopLevelDomain, HTTP status code, HTTP response headers (array of strings)
     */
    public function getToplevelDomainWithHttpInfo($top_level_domain_identifier, $fields = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MittwaldApi\Model\TopLevelDomain' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                        if ('\MittwaldApi\Model\TopLevelDomain' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MittwaldApi\Model\TopLevelDomain', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MittwaldApi\Model\TopLevelDomain';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MittwaldApi\Model\TopLevelDomain',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
            ...
            switch($statusCode) {
                case 200:
                    if ('\MittwaldApi\Model\Domain[]' === '\SplFileObject') {
                        ...
                        $content = $responseBody->getContents();
                        if ('\MittwaldApi\Model\Domain[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     * @param  \MittwaldApi\Model\DomainRegistration $domain_registration Daten für eine Domain-Registrierung (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MittwaldApi\Model\Domain[]
     */
    public function registerNewDomain($account_identifier, $domain_registration)
    {
        list($response) = $this->registerNewDomainWithHttpInfo($account_identifier, $domain_registration);
        return $response;
    }
     ...
     */
    public function registerNewDomainWithHttpInfo($account_identifier, $domain_registration)
    {
        $request = $this->registerNewDomainRequest($account_identifier, $domain_registration);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerNewDomainAsync($account_identifier, $domain_registration)
    {
        return $this->registerNewDomainAsyncWithHttpInfo($account_identifier, $domain_registration)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerNewDomainAsyncWithHttpInfo($account_identifier, $domain_registration)
    {
        $returnType = '\MittwaldApi\Model\Domain[]';
        $request = $this->registerNewDomainRequest($account_identifier, $domain_registration);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function registerNewDomainRequest($account_identifier, $domain_registration)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // verify the required parameter 'domain_registration' is set
        if ($domain_registration === null || (is_array($domain_registration) && count($domain_registration) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_registration when calling registerNewDomain'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($domain_registration)) {
            $_tempBody = $domain_registration;
        }
