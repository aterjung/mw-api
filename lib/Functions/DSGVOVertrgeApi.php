...
class DSGVOVertrgeApi
{
     ...
     * @return void
     */
    public function acceptGDPRContract($contract_identifier, $unknown_base_type = null)
    {
        $this->acceptGDPRContractWithHttpInfo($contract_identifier, $unknown_base_type);
    }
     ...
     */
    public function acceptGDPRContractWithHttpInfo($contract_identifier, $unknown_base_type = null)
    {
        $request = $this->acceptGDPRContractRequest($contract_identifier, $unknown_base_type);
     ...
     */
    public function acceptGDPRContractAsync($contract_identifier, $unknown_base_type = null)
    {
        return $this->acceptGDPRContractAsyncWithHttpInfo($contract_identifier, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function acceptGDPRContractAsyncWithHttpInfo($contract_identifier, $unknown_base_type = null)
    {
        $returnType = '';
        $request = $this->acceptGDPRContractRequest($contract_identifier, $unknown_base_type);
     ...
     */
    protected function acceptGDPRContractRequest($contract_identifier, $unknown_base_type = null)
    {
            ...
            switch($statusCode) {
                case 201:
                    if ('\MittwaldApi\Model\GDPRContract' === '\SplFileObject') {
                        ...
                        if ('\MittwaldApi\Model\GDPRContract' !== 'string') {
     ...
     *
     * @param  \MittwaldApi\Model\GDPRContractPreset $gdpr_contract_preset gdpr_contract_preset (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MittwaldApi\Model\GDPRContractPreset
     */
    public function createGDPRContractPresets($gdpr_contract_preset)
    {
        list($response) = $this->createGDPRContractPresetsWithHttpInfo($gdpr_contract_preset);
        return $response;
    }
     ...
     * Vertragskonfiguration - Speichert eine Vertrags-Konfiguration
     *
     * @param  \MittwaldApi\Model\GDPRContractPreset $gdpr_contract_preset (required)
     *
     * @throws \MittwaldApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MittwaldApi\Model\GDPRContractPreset, HTTP status code, HTTP response headers (array of strings)
     */
    public function createGDPRContractPresetsWithHttpInfo($gdpr_contract_preset)
    {
        $request = $this->createGDPRContractPresetsRequest($gdpr_contract_preset);
            ...
            switch($statusCode) {
                case 201:
                    if ('\MittwaldApi\Model\GDPRContractPreset' === '\SplFileObject') {
                        ...
                        $content = $responseBody->getContents();
                        if ('\MittwaldApi\Model\GDPRContractPreset' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGDPRContractPresetsAsync($gdpr_contract_preset)
    {
        return $this->createGDPRContractPresetsAsyncWithHttpInfo($gdpr_contract_preset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGDPRContractPresetsAsyncWithHttpInfo($gdpr_contract_preset)
    {
        $returnType = '\MittwaldApi\Model\GDPRContractPreset';
        $request = $this->createGDPRContractPresetsRequest($gdpr_contract_preset);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createGDPRContractPresetsRequest($gdpr_contract_preset)
    {
        // verify the required parameter 'gdpr_contract_preset' is set
        if ($gdpr_contract_preset === null || (is_array($gdpr_contract_preset) && count($gdpr_contract_preset) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $gdpr_contract_preset when calling createGDPRContractPresets'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($gdpr_contract_preset)) {
            $_tempBody = $gdpr_contract_preset;
        }
            ...
            switch($statusCode) {
                case 200:
                    if ('\MittwaldApi\Model\GDPRPDF' === '\SplFileObject') {
                        ...
                        $content = $responseBody->getContents();
                        if ('\MittwaldApi\Model\GDPRPDF' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return void
     */
    public function sendGDPRContractMail($contract_identifier, $unknown_base_type = null)
    {
        $this->sendGDPRContractMailWithHttpInfo($contract_identifier, $unknown_base_type);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendGDPRContractMailWithHttpInfo($contract_identifier, $unknown_base_type = null)
    {
        $request = $this->sendGDPRContractMailRequest($contract_identifier, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendGDPRContractMailAsync($contract_identifier, $unknown_base_type = null)
    {
        return $this->sendGDPRContractMailAsyncWithHttpInfo($contract_identifier, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendGDPRContractMailAsyncWithHttpInfo($contract_identifier, $unknown_base_type = null)
    {
        $returnType = '';
        $request = $this->sendGDPRContractMailRequest($contract_identifier, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendGDPRContractMailRequest($contract_identifier, $unknown_base_type = null)
    {
        // verify the required parameter 'contract_identifier' is set
        if ($contract_identifier === null || (is_array($contract_identifier) && count($contract_identifier) === 0)) {
            throw new \InvalidArgumentException(
