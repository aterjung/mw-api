...
class WebhooksApi
{
     ...
     *
     * @param  \MittwaldApi\Model\Webhook $webhook Die Webhook-Konfiguration (required)
     *
            ...
            switch($statusCode) {
                case 200:
                    if ('\MittwaldApi\Model\Webhook' === '\SplFileObject') {
                        ...
                        if ('\MittwaldApi\Model\Webhook' !== 'string') {
     ...
     * @return \MittwaldApi\Model\Webhook|\MittwaldApi\Model\Message
     */
    public function updateWebhook($webhook_identifier, $webhook)
    {
        list($response) = $this->updateWebhookWithHttpInfo($webhook_identifier, $webhook);
        return $response;
    }
     ...
     * @return array of \MittwaldApi\Model\Webhook|\MittwaldApi\Model\Message, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWebhookWithHttpInfo($webhook_identifier, $webhook)
    {
        $request = $this->updateWebhookRequest($webhook_identifier, $webhook);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsync($webhook_identifier, $webhook)
    {
        return $this->updateWebhookAsyncWithHttpInfo($webhook_identifier, $webhook)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsyncWithHttpInfo($webhook_identifier, $webhook)
    {
        $returnType = '\MittwaldApi\Model\Webhook';
        $request = $this->updateWebhookRequest($webhook_identifier, $webhook);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateWebhookRequest($webhook_identifier, $webhook)
    {
        // verify the required parameter 'webhook_identifier' is set
        if ($webhook_identifier === null || (is_array($webhook_identifier) && count($webhook_identifier) === 0)) {
            throw new \InvalidArgumentException(
