 ...
 */
class AcceptGDPRContractRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'acceptGDPRContractRequest';
     ...
     * Sets email
     *
     * @param bool|null $email Wahr, wenn der Vertrag zusätzlich an beide Vertragspartner versendet werden soll
     *
     * @return self
     */
